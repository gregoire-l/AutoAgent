module autoagent/tests

go 1.24.1

require (
	autoagent/go-core v0.0.0-00010101000000-000000000000
	github.com/stretchr/testify v1.10.0
	github.com/testcontainers/testcontainers-go v0.34.0
)

// Local module replacements
replace autoagent/go-core => ../go-core

require (
	autoagent/api v0.0.0-00010101000000-000000000000 // indirect
