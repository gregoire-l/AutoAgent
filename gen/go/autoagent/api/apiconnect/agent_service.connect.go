...
const (
	...
	AgentSessionServiceName = "autoagent.api.AgentSessionService"
)
...
const (
	...
	// StartSession RPC.
	AgentSessionServiceStartSessionProcedure = "/autoagent.api.AgentSessionService/StartSession"
	// AgentSessionServiceExecuteStepProcedure is the fully-qualified name of the AgentSessionService's
	// ExecuteStep RPC.
	AgentSessionServiceExecuteStepProcedure = "/autoagent.api.AgentSessionService/ExecuteStep"
	// AgentSessionServiceStopSessionProcedure is the fully-qualified name of the AgentSessionService's
	// StopSession RPC.
	AgentSessionServiceStopSessionProcedure = "/autoagent.api.AgentSessionService/StopSession"
)

// AgentSessionServiceClient is a client for the autoagent.api.AgentSessionService service.
...
// NewAgentSessionServiceClient constructs a client for the autoagent.api.AgentSessionService
...
// StartSession calls autoagent.api.AgentSessionService.StartSession.
...
// ExecuteStep calls autoagent.api.AgentSessionService.ExecuteStep.
...
// StopSession calls autoagent.api.AgentSessionService.StopSession.
...
// AgentSessionServiceHandler is an implementation of the autoagent.api.AgentSessionService service.
...
func NewAgentSessionServiceHandler(svc AgentSessionServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/autoagent.api.AgentSessionService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAgentSessionServiceHandler) StartSession(context.Context, *connect.Request[api.StartSessionRequest]) (*connect.Response[api.StartSessionResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("autoagent.api.AgentSessionService.StartSession is not implemented"))
}
...
func (UnimplementedAgentSessionServiceHandler) ExecuteStep(context.Context, *connect.BidiStream[api.ExecuteStepRequest, api.ExecuteStepResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("autoagent.api.AgentSessionService.ExecuteStep is not implemented"))
}
...
func (UnimplementedAgentSessionServiceHandler) StopSession(context.Context, *connect.Request[api.StopSessionRequest]) (*connect.Response[api.StopSessionResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("autoagent.api.AgentSessionService.StopSession is not implemented"))
}
