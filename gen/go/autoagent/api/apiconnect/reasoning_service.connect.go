...
const (
	...
	ReasoningServiceName = "autoagent.api.ReasoningService"
)
...
const (
	...
	// GenerateOptions RPC.
	ReasoningServiceGenerateOptionsProcedure = "/autoagent.api.ReasoningService/GenerateOptions"
	// ReasoningServiceScoreOptionsProcedure is the fully-qualified name of the ReasoningService's
	// ScoreOptions RPC.
	ReasoningServiceScoreOptionsProcedure = "/autoagent.api.ReasoningService/ScoreOptions"
)

// ReasoningServiceClient is a client for the autoagent.api.ReasoningService service.
...
// NewReasoningServiceClient constructs a client for the autoagent.api.ReasoningService service. By
...
// GenerateOptions calls autoagent.api.ReasoningService.GenerateOptions.
...
// ScoreOptions calls autoagent.api.ReasoningService.ScoreOptions.
...
// ReasoningServiceHandler is an implementation of the autoagent.api.ReasoningService service.
...
func NewReasoningServiceHandler(svc ReasoningServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/autoagent.api.ReasoningService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedReasoningServiceHandler) GenerateOptions(context.Context, *connect.Request[api.GenerateOptionsRequest]) (*connect.Response[api.GenerateOptionsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("autoagent.api.ReasoningService.GenerateOptions is not implemented"))
}
...
func (UnimplementedReasoningServiceHandler) ScoreOptions(context.Context, *connect.Request[api.ScoreOptionsRequest]) (*connect.Response[api.ScoreOptionsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("autoagent.api.ReasoningService.ScoreOptions is not implemented"))
}
